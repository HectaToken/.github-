...
▓▓  ▓▓▓▓▒▒▒▒▒▒▒▒▒▒▓▓  ██▓▓██  
  ...
  ▓▓▓▓                        
   ...
   # Hecta features:
   18% tax on transactions
   ⤏ 2% fee distributed to all holders every transaction
   ⤏ 15% fee auto added to the liquidity pool every transaction
...
contract Hecta is Context, IERC20, Ownable {
    ...
    string private _name = "Hecta ";
    string private _symbol = "HEC";
    ...
    function _transferBurn(uint256 tBurn) private {
		...
		if(_isExcludedFromFee[BURN_ADDRESS])
